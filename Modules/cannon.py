...
from mapping import cannons
from Modules.display_object import DisplayObject

CIRCLE_COLOR = (100, 0, 0)  # The color we want the indicator circle to be
CIRCLE_SIZE = 4  # The size of the indicator circle we want
COORD_OFFSET = 0x100


class Cannon(DisplayObject):
    """
    Class to generate information for a cannons object in memory
    """
    ...
    def __init__(self, memory_reader, actor_id, address, my_coords, raw_name):
        ...
        All of this data represents a "cannons". If you want to add more, you will
        ...
        :param my_coords: a dictionary of the local cannons coordinates
        ...
        # Generate our cannon's info
        # self.name = raw_name
        self.name = cannons.get(self.raw_name).get("Name")
    ...
    def _build_text_render(self) -> Label:
        ...
        :rtype: Label
        :return: What text we want displayed next to the object
        """
        if self.screen_coords:
    ...
    def update(self, my_coords: dict):
        """
        A generic method to update all the interesting data about a cannon
