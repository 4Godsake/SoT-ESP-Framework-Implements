...
class Player(DisplayObject):
    """
    Class to generate information for a players object in memory
    """
    ...
    def __init__(self, memory_reader, actor_id, address, my_coords, raw_name):
        ...
        All of this data represents a "players". If you want to add more, you will
        ...
        self.name = players.get(self.raw_name).get("Name")
    ...
    def _build_text_render(self) -> Label:
        ...
        if self.screen_coords:
            return Label(self.text_str,
                         ...
                         batch=main_batch, group=self.group, font_size=self.fontsize)

        return Label(self.text_str, x=0, y=0, batch=main_batch,
                     group=self.group, font_size=self.fontsize)
